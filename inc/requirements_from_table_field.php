...
if( !class_exists('REQUIREMENTS_FROM_TABLE_FIELD') ) :


class REQUIREMENTS_FROM_TABLE_FIELD   extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('From Table', 'TEXTDOMAIN');
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('From Table','TEXTDOMAIN'),
...
// initialize
new REQUIREMENTS_FROM_TABLE_FIELD();
